...
[[ "$(id -un)" == "mads" && "$HOME" == "/Users/mads" ]] || \
  fail "bootstrap is configured for user mads at /Users/mads."
...
printf 'Bootstrap complete. Finish the GUI and App Store steps in README.md.\n'
